<template>
  <b-form class="mt-3">
    ...
    <b-row class="mt-2">
      <b-form-checkbox
        id="customer_status"
        v-model="donors.customer_status"
